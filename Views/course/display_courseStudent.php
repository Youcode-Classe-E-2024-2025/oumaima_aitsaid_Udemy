...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="index.php?action=dashboardd" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                Back to Dashboard
            </a>
        </div>
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
    <a class="bg-purple-600 hover:bg-purple-800 text-white font-bold py-2 px-4 rounded" 
       href="index.php?action=enroll&course_id=<?php echo htmlspecialchars($course['id']); ?>">
        Join this course
    </a>
</div>        </div>
    </div>
